-- Phase 2: Database Deduplication - Konsolidierung & Absicherung
-- Basierend auf docs/db-dedup-audit.md
...
-- ===========================
-- 3. LEGACY TABELLEN ZU VIEWS UMWANDELN
-- ===========================
...
-- ===========================
-- 5. JOBALARM FEATURE-FLAG & RLS LOCKDOWN
-- ===========================
...
-- Log der Migration in admin_actions
