...
-- Standard für bestehende Daten setzen
UPDATE public.job_requests 
SET billing_model = 'agency' 
WHERE billing_model NOT IN ('direct', 'agency') OR billing_model IS NULL;

-- Default entfernen, dann Typ ändern, dann Default wieder setzen
ALTER TABLE public.job_requests
  ALTER COLUMN billing_model DROP DEFAULT;

ALTER TABLE public.job_requests
  ALTER COLUMN billing_model TYPE public.billing_model_enum
  USING billing_model::public.billing_model_enum;

ALTER TABLE public.job_requests
  ALTER COLUMN billing_model SET DEFAULT 'agency'::public.billing_model_enum;
